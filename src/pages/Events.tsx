        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {eventTypes.map((event) => (
              <div
                key={event.id}
                className="p-6 rounded-2xl bg-card border border-border hover:shadow-elevated transition-all hover:-translate-y-1"
              >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {upcomingEvents.map((event, index) => (
              <div
                key={index}
                className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 rounded-xl bg-background border border-border hover:shadow-soft transition-shadow"
              >
                <div>
