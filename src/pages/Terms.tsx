...
const sections = [
  {
    ...
    content: `By accessing and using the MindfulPath platform ("Service"), you agree to be bound by these Terms and Conditions ("Terms"). If you disagree with any part of these terms, you may not access the Service.
...
By creating an account or using our services, you confirm that you are at least 18 years of age or have obtained parental/guardian consent where applicable.`
  },
  {
    ...
    content: `MindfulPath provides a platform connecting individuals with licensed mental health professionals for therapy services, including:
...
MindfulPath serves as a platform connecting clients with independent psychologists. Psychologists are independent contractors, not employees of MindfulPath.`
  },
  {
    id: "volunteers",
    icon: Users,
    title: "7. Volunteer Terms",
    content: `Volunteers participating in MindfulPath programs agree to:
• Complete required training and background checks
• Maintain confidentiality of all sensitive information
• Follow organizational policies and procedures
• Represent MindfulPath professionally in all activities
...
Volunteer participation is at-will and may be terminated by either party at any time.`
  },
  {
    ...
    content: `The Service and its original content, features, and functionality are owned by MindfulPath and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.
...
• Create derivative works based on our content`
  },
  {
    ...
    content: `To the maximum extent permitted by law, MindfulPath shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from:
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 p-6 rounded-2xl bg-primary/5 border border-primary/20">
              <p className="text-sm text-foreground">
                <strong>By using MindfulPath services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions.</strong> If you have any questions or concerns, please contact us before using our services.
              </p>
            </div>
          </div>
        </div>
